...
public class CopybookDriver {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    options.addOption("copybook_filetype", true, "--copybook_filetype MFVB somtimes requires --recordtype_name, --record_typevalue");
	    ...
	    System.out.println("Input:" +inputPath+", Output: "+outputPath+", AppName: "+appname+", CopyBookName: "+copybookName+", copybookSplitOpt: "+copybookSplitOpt +
	    		", copybookType: "+copybookType+"useRecord: "+useRecord+", RecTypeValue: "+recTypeValue+", RecTypeName: "+recTypeName+", hivePath: "+hivePath+", hiveTableName: "+hiveTableName+
