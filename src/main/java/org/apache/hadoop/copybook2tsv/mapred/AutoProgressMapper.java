 ...
 */
public class AutoProgressMapper<KEYIN, VALIN, KEYOUT, VALOUT> extends CopybookMapper<KEYIN, VALIN, KEYOUT, VALOUT> {

	public static final Log LOG = LogFactory.getLog(AutoProgressMapper.class.getName());

	public static final String MAX_PROGRESS_PERIOD_KEY = "copybook.mapred.auto.progress.max";
	public static final String SLEEP_INTERVAL_KEY = "copybook.mapred.auto.progress.sleep";
	public static final String REPORT_INTERVAL_KEY = "copybook.mapred.auto.progress.report";
